...
type SliderTrackProps = Primitive.SliderTrackProps &
    VariantProps<typeof sliderStyles>;
            ...
            style={
                values.length === 1
                    ...
                    ? {
                          ...
                          width: `${
                              Math.abs(
                                  getThumbPercent(0) - getThumbPercent(1)
                              ) * 100
                          }%`,
                      }
                    : {
...
type SliderThumbProps = Primitive.SliderThumbProps &
    VariantProps<typeof sliderStyles>;
...
const SliderValueLabel = (props: LabelProps) => {
    ...
    return (
        <Primitive.SliderOutput
            ...
            className={Primitive.composeRenderProps(
                props.className,
                (className) => valueLabel({ className })
            )}
        >
