...
const MenuContent = <T extends object>({
    ...
    let popoverContext = Primitive.useSlottedContext(Primitive.PopoverContext)!;
    ...
    >
        ...
        {(values) => (
            <>
                ...
                {values.hasSubmenu && (
                    <ChevronsRight className="gpfw ml-auto size-3.5" />
                )}
            </>
        )}
    </Primitive.MenuItem>
...
export interface MenuHeaderProps
    extends React.ComponentProps<typeof Primitive.Header> {
    inset?: boolean;
    separator?: boolean;
}
